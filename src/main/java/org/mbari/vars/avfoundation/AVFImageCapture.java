...
public class AVFImageCapture {
    ...
    public native String[] videoDevicesAsStrings();
        ...
        private void startDevice() {
            ...
            if (isStarted) {
                log.warn("The video device '" +videoSource + "' is already opened");
            }
                ...
                log.warn("A video source has not been selected");
            }
        }
        ...
        private void extractAndLoadNativeLibraries() {
            ...
            if (libraryName != null) {
                ...
                //     throw new RuntimeException("Unable to extract native '" + LIBRARY_NAME +
